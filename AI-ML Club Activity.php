...
<?php
  include 'ICEEM_Club_Connection.php';
   ...
   $emailquery="SELECT * FROM ai_ml_club_activity WHERE remark='$remark'";
 ...
 $insertquery= "INSERT INTO ai_ml_club_activity(name,fromdate,todate,fees,remark) VALUES('$name','$date',
    '$edate','$fees','$remark')";
  ...
  <div class="appoient">
    <h1 class="heading">AI-ML Club Activity</h1>
    ...
    <div class="book">
      ...
      <div>
     <a href="View AI-ML Club Activity.php"><button class="view">View Activity</a></button>
    </div>
</div>
</body>
</html>