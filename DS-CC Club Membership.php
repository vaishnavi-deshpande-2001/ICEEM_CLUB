...
<head>
	...
	<title>DS-CC Club Membership Form</title>
...
<body>
  ...
  include 'ICEEM_Club_Connection.php';
   ...
   $emailquery="SELECT * FROM ds_cc_club_membership WHERE email='$email'";
 ...
 $insertquery= "INSERT INTO ds_cc_club_membership(regno, date, other, name, gender, datebirth, yearstudy, contact, email, address, declaration) VALUES ('$regno','$date','$other','$name','gender','$datebirth','$yearstudy','$contact','$email','$address','$declaration')";
 ...
 <h1 class="i"> INTERNATIONAL CENTRE OF EXCELLENCE IN ENGINEERING <br> AND MANAGEMENT(ICEEM)</h1>
	...
	<div>
		<h1 style="margin-top: 20px; margin-left:570px"> DS-CC Club</h1>
